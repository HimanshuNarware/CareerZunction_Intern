...
function Footer() {
  return (
    <div> <div className="page_2 footer">
...
<p className='doc-pera doc-perag'>What is Open-Source.</p>
      ...
      <p className='doc-pera doc-perag'>How to start contributing to Open-Source.</p>
</div>
      </div>
      ...
      <button size="size" type="defautl" className='button-star'>
        {' '}
       < FaStar style={{margin:"-2px 2px",lineHeight:"2px"}} className='star' />Star us
      </button>
    </div>
  </div></div>
  )
