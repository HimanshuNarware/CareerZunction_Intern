      ...
      <div className="page_1">
        <div className="wrapper_p1">
          ...
          <div className="wrapper-bx-2">
            <div className="wrapper-bx-2-0 wrapper-bx-2-1 outline hover-ele">
            ...
            {/* </div> */}
            <div className="wrapper-bx-2-0 wrapper-bx-2-2 outline hover-ele">
              <i className="icon" style={{ color: "blueviolet" }}>
                <GiGlobe />
              </i>
              <div className="wrapper-subbx ">
            ...
            <div className="wrapper-bx-2-0 wrapper-bx-2-3 outline hover-ele">
              <i className="icon" style={{ color: "blueviolet" }}>
                <FaPeopleGroup />
              </i>
              <div className="wrapper-subbx ">
            ...
            <div className=" wrapper-bx-2-0 wrapper-bx-2-4 outline hover-ele">
              <i className="icon" style={{ color: "blueviolet" }}>
                <FaIndianRupeeSign />
              </i>
              <div className="wrapper-subbx ">
