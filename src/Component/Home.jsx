      ...
      <div className="page_1">
        <div className="wrapper_p1">
          ...
          <div className="wrapper-bx-2">
            <div className="wrapper-bx-2-0 wrapper-bx-2-1">
            ...
            {/* </div> */}
            <div className="wrapper-bx-2-0 wrapper-bx-2-2">
              <i className="icon" style={{ color: "blueviolet" }}>
                <GiGlobe />
              </i>
              <div className="wrapper-subbx">
                ...
                <p>
                  ...
                  internships, and open-source programs.
                </p>
              </div>
            </div>
            <div className="wrapper-bx-2-0 wrapper-bx-2-3">
              <i className="icon" style={{ color: "blueviolet" }}>
                <FaPeopleGroup />
              </i>
              <div className="wrapper-subbx">
                ...
                <p>
                  {" "}
                  CareerZunction is an open-source project, inviting
                  contributions from developers, designers, and career experts
                  who want to make a difference.
                </p>
              </div>
            </div>
            <div className=" wrapper-bx-2-0 wrapper-bx-2-4">
              <i className="icon" style={{ color: "blueviolet" }}>
                <FaIndianRupeeSign />
              </i>
              <div className="wrapper-subbx">
                ...
                <p>
                  {" "}
                  We believe that access to career-building opportunities should
                  be available to everyone. That’s why CareerZunction is
