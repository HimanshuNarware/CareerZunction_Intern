...
const CodeOfConduct = () => {
    ...
    return (
        <Container>
            ...
            <Footer>
                If you have any questions or concerns about this code of conduct, please contact us at <a href="mailto:himanshunarware77@gmail.com" style={{ color: 'white' }}>himanshunarware77@gmail.com</a>
            </Footer>
        </Container>
    );
};
